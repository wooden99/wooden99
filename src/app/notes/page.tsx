      ...
      <div className="px-4 md:w-1/2 md:mx-auto py-8">
        ...
        <div className="mt-4">
          ...
          <div className="mt-8 flex items-center">
            ...
            <Link href="/notes" className="w-1/3 bg-white border-b-2 border-primary px-4 py-2 text-center hover:bg-gray-100 outline-none focus-visible:bg-gray-100 rounded-t-lg duration-200">Notes</Link>
